                                ...
                                <div className="container">
                                    ...
                                    <div className="icon-grid-cnt-main">
                                        <div className="columns is-multiline">
                                            <div className="column is-6-tablet">
                                                ...
                                                <div className="icon-grid-cnt-img">
                                                    <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                        <img src="../static/images/icons/png/react-dev2-01.png" alt="i"/>
                                                    </ScrollAnimation>
                                                    </div>
                                            ...
                                            <div className="icon-grid-cnt-img">
                                            <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                <img src="../static/images/icons/png/react-dev2-03.png" alt="i"/>
                                            </ScrollAnimation>
                                            </div>
                                                <div className="icon-grid-cnt-in">
                                                    <h5>Live Updates</h5>
                                        ...
                                        <div className="columns is-multiline">
                                            ...
                                            <div className="icon-grid-cnt-wrap">
                                                ...
                                                <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                    ...
                                                    <img src="../static/images/icons/png/react-dev3-01.png" alt="i"/>
                                                    </ScrollAnimation>
                                                    </div>
                                                <div className="icon-grid-cnt-in">
                                    ...
                                    <div className="icon-grid-cnt-main">
                                        <div className="columns is-multiline">
                                            ...
                                            <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                ...
                                                <img src="../static/images/icons/png/react-dev4-01.png" alt="i"/>
                                                </ScrollAnimation>
                                                </div>
                                                <div className="icon-grid-cnt-in">
                                            ...
                                            <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                ...
                                                <img src="../static/images/icons/png/react-dev4-02.png" alt="i"/>
                                                </ScrollAnimation>
                                                </div>
                                                <div className="icon-grid-cnt-in">
                                            ...
                                            <ScrollAnimation animateIn="wobble" initiallyVisible={false} animateOnce ="true">
                                                ...
                                                <img src="../static/images/icons/png/react-dev4-03.png" alt="i"/>
                                                </ScrollAnimation>
                                                </div>
                                                <div className="icon-grid-cnt-in">
