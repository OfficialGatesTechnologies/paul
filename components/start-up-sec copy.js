            ...
            <div>
                <section className="startup-sec">
                    ...
                    <div className="sec-ttl sec-ttl-01 has-text-centered py-5">
                        <h1 className="ttl-head">Passion To Drive Small Startups Into Unicorns Comes With WebsitePilot!</h1>
...
customers delighted & make you Brand Visible.</p>
                    ...
                    <ScrollAnimation animateIn="bounceIn" delay={1000} initiallyVisible={false} animateOnce ="true">
